...
**Lara** is a library for developing web user interfaces and web services. Lara gives you full control of the client's HTML Document Object Model (DOM) tree from the server in C#.
